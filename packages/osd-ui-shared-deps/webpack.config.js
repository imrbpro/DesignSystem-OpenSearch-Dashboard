...
exports.getWebpackConfig = ({ dev = false } = {}) => ({
  ...
  entry: {
    ...
    'osd-ui-shared-deps.dsChallengeTheme.dark': ['@elastic/eui/dist/eui_theme_v9_dark.css'],
    'osd-ui-shared-deps.dsChallengeTheme.light': ['@elastic/eui/dist/eui_theme_v9_light.css'],
  },
  context: __dirname,
