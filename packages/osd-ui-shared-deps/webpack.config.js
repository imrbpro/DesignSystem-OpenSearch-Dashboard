...
exports.getWebpackConfig = ({ dev = false } = {}) => ({
  ...
  entry: {
    ...
    'osd-ui-shared-deps.ds_challenge_theme.dark': ['@elastic/eui/dist/eui_theme_v9_dark.css'],
    'osd-ui-shared-deps.ds_challenge_theme.light': ['@elastic/eui/dist/eui_theme_v9_light.css'],
  },
  context: __dirname,
